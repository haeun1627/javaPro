...
<form class="form-style-9" action="/jspPro/ch03/viewParameter1.jsp" method="post">
<ul>
<li>
...
<li>
    ...
    <input type="url" name="url" class="field-style field-split align-right" placeholder="Website" />
</li>
<li>
...
<table border=1;>
<tr><td>
name = <%=request.getParameter("name") %></td>
<td>
email = <%=request.getParameter("email") %></td></tr>
<tr><td>
phone = <%=request.getParameter("phone") %></td>
<td>
url = <%=request.getParameter("url") %></td></tr>
<tr><td colspan="2">
